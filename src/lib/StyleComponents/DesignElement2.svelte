<script lang="ts">
	...
	export let background: string = '--theme-bg-pri';
	export let tracer: string = '--theme-text-contact';
...
<div
	class="center center-column design-base"
	style="--color: var({tracer}); --bg-color: var({background}); --height: {height}px; --width: {width}px; --gradient-angle: {gradientAngle}deg"
>
